...
use app\common\validate\inspection\InspectionSettingValidate;
...
class Setting extends BaseController
{
     ...
     * @Apidoc\Returned(ref="app\common\service\system\InspectionSettingService\info", field="logo_url,favicon_url,login_bg_url")
     */
    public function systemInfo()
    {
        $data = InspectionSettingService::info('ins_system_name,ins_page_title,logo_id,favicon_id,login_bg_id,login_bg_color,page_limit,logo_url,favicon_url,login_bg_url');
    ...
    public function systemEdit()
    {
        ...
        validate(InspectionSettingValidate::class)->scene('system_edit')->check($param);

        $data = InspectionSettingService::edit($param);
    ...
    /**
     * @Apidoc\Title("缓存设置信息")
     * @Apidoc\Returned(ref="app\common\service\system\InspectionSettingService\info", field="cache_type")
     */
    public function cacheInfo()
    {
        $data = InspectionSettingService::info('cache_type');
    ...
    {
        $data = InspectionSettingService::cacheClear();
    ...
    {
        $data = InspectionSettingService::info('token_key,token_exp,is_multi_login');
    ...
    public function tokenEdit()
    {
        ...
        validate(InspectionSettingValidate::class)->scene('token_edit')->check($param);
    ...
    {
        $data = InspectionSettingService::info('captcha_switch,captcha_mode,captcha_type');
    ...
    public function captchaEdit()
    {
        ...
        validate(InspectionSettingValidate::class)->scene('captcha_edit')->check($param);
    ...
    {
        $data = InspectionSettingService::info('log_switch,log_save_time');
    ...
    public function logEdit()
    {
        ...
        validate(InspectionSettingValidate::class)->scene('log_edit')->check($param);
    ...
    {
        $data = InspectionSettingService::info('api_rate_num,api_rate_time');
    ...
    public function apiEdit()
    {
        ...
        validate(InspectionSettingValidate::class)->scene('api_edit')->check($param);
    ...
    {
        $data = InspectionSettingService::info('email_host,email_port,email_secure,email_username,email_password,email_setfrom,email_test');
    ...
    public function emailEdit()
    {
        ...
        validate(InspectionSettingValidate::class)->scene('email_edit')->check($param);
    ...
    public function emailTest()
    {
        ...
        validate(InspectionSettingValidate::class)->scene('email_test')->check($param);

        $data = InspectionSettingService::emailTest($param);
    ...
    public function serverInfo()
    {
        ...
        $data = InspectionSettingService::serverInfo($force);
