...
use app\common\validate\merchant\MerchantUserValidate;
...
class User extends BaseController
{
    ...
    public function list()
    {
        ...
        $data = MerchantUserService::list($where, $this->page(), $this->limit(), $this->order());

        $data['role']  = MerchantRoleService::list([where_delete()], 0, 0, [], 'role_id,role_name')['list'] ?? [];
    ...
    {
        $param = $this->params(['mer_user_id/d' => '']);

        validate(MerchantUserValidate::class)->scene('info')->check($param);

        $data = MerchantUserService::info($param['mer_user_id'], true, true);
    ...
    public function add()
    {
        $param = $this->params(MerchantUserService::$edit_field);
        $param['password'] = $this->param('password');

        validate(MerchantUserValidate::class)->scene('add')->check($param);

        $data = MerchantUserService::add($param);
    ...
    public function edit()
    {
        ...
        validate(MerchantUserValidate::class)->scene('edit')->check($param);

        $data = MerchantUserService::edit($param['mer_user_id'], $param);
    ...
    public function dele()
    {
        ...
        validate(MerchantUserValidate::class)->scene('dele')->check($param);

        $data = MerchantUserService::dele($param['ids']);
    ...
    public function editrole()
    {
        ...
        validate(MerchantUserValidate::class)->scene('editrole')->check($param);

        $data = MerchantUserService::edit($param['ids'], $param);
    ...
    public function repwd()
    {
        ...
        validate(MerchantUserValidate::class)->scene('repwd')->check($param);

        MerchantUserService::edit($param['ids'], $param);
    ...
    public function super()
    {
        ...
        validate(MerchantUserValidate::class)->scene('super')->check($param);
    ...
    public function disable()
    {
        ...
        validate(MerchantUserValidate::class)->scene('disable')->check($param);
