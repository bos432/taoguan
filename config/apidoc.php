    ...
    'apps' => [
        [
            ...
            'groups' => [
                ...
                ['title' => '溯源管理', 'name' => 'trace'],
                ['title' => '商家管理', 'name' => 'merchant'],
                ['title' => '检测机构', 'name' => 'inspection'],
        ...
        [
            ...
            'title' => 'merchant',
            // （必须）控制器目录地址
            'path' => 'app\merchant\controller',
            // （必须）唯一的key
            'key' => 'merchant',
            // （选配）当前应用全局参数
            'params' => [
                // （选配）当前应用全局的请求Header
                'header' => [['name' => env('merchant.token_name', 'MerchantToken'), 'type' => 'string', 'require' => true, 'desc' => 'merchant token']],
                // （选配）当前应用全局的请求Query
                'query' => [['name' => env('merchant.token_name', 'MerchantToken'), 'type' => 'string', 'require' => true, 'desc' => 'merchant token']],
                // （选配）当前应用全局的请求Body
                'body' => [['name' => env('merchant.token_name', 'MerchantToken'), 'type' => 'string', 'require' => true, 'desc' => 'merchant token']],
            ],
            // （选配）当前应用控制器分组
            'groups' => [
                ['title' => '登录', 'name' => 'logout'],
        ...
        [
            ...
            'title' => 'inspection',
            // （必须）控制器目录地址
            'path' => 'app\inspection\controller',
            // （必须）唯一的key
            'key' => 'inspection',
            // （选配）当前应用全局参数
            'params' => [
                // （选配）当前应用全局的请求Header
                'header' => [['name' => env('inspection.token_name', 'InspectionToken'), 'type' => 'string', 'require' => true, 'desc' => 'inspection token']],
                // （选配）当前应用全局的请求Query
                'query' => [['name' => env('inspection.token_name', 'InspectionToken'), 'type' => 'string', 'require' => true, 'desc' => 'inspection token']],
                // （选配）当前应用全局的请求Body
                'body' => [['name' => env('inspection.token_name', 'InspectionToken'), 'type' => 'string', 'require' => true, 'desc' => 'inspection token']],
            ],
            // （选配）当前应用控制器分组
            'groups' => [
                ['title' => '登录', 'name' => 'logout'],
                ['title' => '控制台', 'name' => 'console'],
                ['title' => '检测订单', 'name' => 'order'],
                ['title' => '文件管理', 'name' => 'file'],
                ['title' => '系统管理', 'name' => 'system'],
            ],
        ],
