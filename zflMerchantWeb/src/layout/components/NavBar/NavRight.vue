<template>
  <div v-if="device !== 'mobile'" class="setting-container">
    ...
    <!-- 系统设置 -->
    <div class="setting-item" v-if="checkPermission(['merchant/system.UserCenter/setting'])">
    ...
    <div
      class="setting-item"
      v-if="checkPermission(['merchant/system.Setting/cacheClear'])"
      @click="clearCache"
    >
  ...
  <el-dropdown trigger="click">
    ...
    <template #dropdown>
      <el-dropdown-menu>
        ...
        <el-dropdown-item>
          <router-link
            v-if="checkPermission(['merchant/system.UserCenter/info'])"
