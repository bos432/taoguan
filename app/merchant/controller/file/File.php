...
namespace app\merchant\controller\file;

use app\common\controller\BaseController;
use app\common\validate\file\MerchantFileValidate;
use app\common\service\file\MerchantFileService;
use app\common\service\file\MerchantGroupService;
use app\common\service\file\MerchantTagService;
...
class File extends BaseController
{
    ...
    public function list()
    {
        ...
        $data = MerchantFileService::list($where, $this->page(), $this->limit(), $this->order());

        $data['group'] = MerchantGroupService::list([where_delete()], 0, 0, [], 'group_id,group_name')['list'] ?? [];
        $data['tag']   = MerchantTagService::list([where_delete()], 0, 0, [], 'tag_id,tag_name')['list'] ?? [];
    ...
    public function info()
    {
        ...
        validate(MerchantFileValidate::class)->scene('info')->check($param);

        $data = MerchantFileService::info($param['file_id']);
    ...
    public function add()
    {
        ...
        $edit_field = MerchantFileService::$edit_field;
        ...
        if ($type == 'url') {
            ...
            foreach ($file_urls as $file_url) {
                ...
                validate(MerchantFileValidate::class)->scene('addurl')->check($param);
                $files[] = $param;
            }
            foreach ($files as $file) {
                $data[] = MerchantFileService::add($file);
            }
            if (count($data) == 1) {
                $data = $data[0];
            }
            ...
            validate(MerchantFileValidate::class)->scene('add')->check($param);
            $data = MerchantFileService::add($param);
    ...
    {
        $param = $this->params(MerchantFileService::$edit_field);

        validate(MerchantFileValidate::class)->scene('edit')->check($param);

        $data = MerchantFileService::edit($param['file_id'], $param);
    ...
    public function dele()
    {
        ...
        validate(MerchantFileValidate::class)->scene('dele')->check($param);

        $data = MerchantFileService::dele($param['ids']);
    ...
    public function editgroup()
    {
        ...
        validate(MerchantFileValidate::class)->scene('editgroup')->check($param);

        $data = MerchantFileService::edit($param['ids'], $param);
    ...
    public function edittag()
    {
        ...
        validate(MerchantFileValidate::class)->scene('edittag')->check($param);
    ...
    public function edittype()
    {
        ...
        validate(MerchantFileValidate::class)->scene('edittype')->check($param);
    ...
    public function editdomain()
    {
        ...
        validate(MerchantFileValidate::class)->scene('editdomain')->check($param);
    ...
    public function disable()
    {
        ...
        validate(MerchantFileValidate::class)->scene('disable')->check($param);
    ...
    public function recycle()
    {
        ...
        $data = MerchantFileService::list($where, $this->page(), $this->limit(), $order);
    ...
    public function recycleReco()
    {
        ...
        validate(MerchantFileValidate::class)->scene('recycleReco')->check($param);

        $data = MerchantFileService::edit($param['ids'], ['is_delete' => 0]);
    ...
    public function recycleDele()
    {
        ...
        validate(MerchantFileValidate::class)->scene('recycleDele')->check($param);

        $data = MerchantFileService::dele($param['ids'], true);
