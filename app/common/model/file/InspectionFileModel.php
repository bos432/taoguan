 ...
 * 文件管理模型
 */
class InspectionFileModel extends Model
{
    // 表名
    protected $name = 'inspection_file';
    // 表主键
    ...
    {
        return $this->hasOne(InspectionGroupModel::class, 'group_id', 'group_id')->where([where_delete()]);
    }
    /**
     * 获取文件分组名称
     * @Apidoc\Field("")
    ...
    {
        return $this->belongsToMany(InspectionTagModel::class, InspectionTagsModel::class, 'tag_id', 'file_id');
    }
    /**
     * 获取标签id
     * @Apidoc\Field("")
