 ...
 * 商家提现缓存
 */
class MerchantWithdrawalCache
{
    // 缓存标签
    public static $tag = 'merchant_withdrawal';
    // 缓存前缀
    protected static $prefix = 'merchant_withdrawal:';
    /**
     * 缓存键名
     *
     * @param int $id 商家提现id
