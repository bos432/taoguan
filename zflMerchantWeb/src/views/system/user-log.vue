  ...
  <div class="app-container">
    <el-card  class="app-head head-pb20">
      ...
      <el-form :model="query" ref="searchForm" label-width="85px">
        <el-row :gutter="20">
          ...
          <el-col :span="6">
            <el-form-item label="用户：" prop="mer_user_id">
              <el-select
                  v-model="query.mer_user_id"
                  placeholder="用户"
                  @change="search()"
                  clearable
                  filterable
              ...
              >
                <el-option
                    ...
                    :key="item.mer_user_id"
                    :value="item.mer_user_id"
                    :label="item.nickname"
                >
    ...
    <el-card  class="app-main">
      ...
      >
        ...
        <el-table-column prop="mer_user_id" label="用户ID" min-width="100" show-overflow-tooltip />
      ...
      >
        <el-scrollbar class="mt5" native :max-height="height - 30">
          <el-form ref="ref" :rules="rules" :model="model" label-width="110px">
            <el-form-item label="用户ID" prop="mer_user_id">
              <el-input v-model="model.mer_user_id" />
            </el-form-item>
