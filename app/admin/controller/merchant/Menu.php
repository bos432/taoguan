...
use app\common\validate\merchant\MerchantMenuValidate;
...
class Menu extends BaseController
{
    ...
    public function list()
    {
        ...
        $data['list']  = MerchantMenuService::list('tree', $where);
        $data['tree']  = MerchantMenuService::list('tree', [where_delete()], [], 'menu_id,menu_pid,menu_name');
        $data['types'] = MerchantSettingService::menuTypes();
        ...
        if (count($where) > 1) {
            ...
            $data['list'] = MerchantMenuService::list('tree', [[$pk, 'in', $ids], where_delete()]);
        }

        $menu = MerchantMenuService::list('list', $where, [], 'menu_id');
    ...
    public function info()
    {
        ...
        validate(MerchantMenuValidate::class)->scene('info')->check($param);

        $data = MerchantMenuService::info($param['menu_id']);
    ...
    public function add()
    {
        $param = $this->params(MerchantMenuService::$edit_field);

        validate(MerchantMenuValidate::class)->scene('add')->check($param);

        $data = MerchantMenuService::add($param);
    ...
    public function edit()
    {
        ...
        validate(MerchantMenuValidate::class)->scene('edit')->check($param);

        $data = MerchantMenuService::edit($param['menu_id'], $param);
    ...
    public function dele()
    {
        ...
        validate(MerchantMenuValidate::class)->scene('dele')->check($param);

        $data = MerchantMenuService::dele($param['ids']);
    ...
    public function editsort()
    {
        ...
        validate(MerchantMenuValidate::class)->scene('editsort')->check($param);

        if ($param['sort_incdec']) {
            foreach ($param['ids'] as $k => $id) {
                $data[] = MerchantMenuService::update([$id], ['sort' => $param['sort_incdec'] * $k + $param['sort']]);
            }
        } else {
            $data = MerchantMenuService::update($param['ids'], $param);
        }
    ...
    public function editpid()
    {
        ...
        validate(MerchantMenuValidate::class)->scene('editpid')->check($param);
    ...
    public function unlogin()
    {
        ...
        validate(MerchantMenuValidate::class)->scene('unlogin')->check($param);
    ...
    public function unauth()
    {
        ...
        validate(MerchantMenuValidate::class)->scene('unauth')->check($param);
    ...
    public function unrate()
    {
        ...
        validate(MerchantMenuValidate::class)->scene('unrate')->check($param);
    ...
    public function hidden()
    {
        ...
        validate(MerchantMenuValidate::class)->scene('hidden')->check($param);
    ...
    public function disable()
    {
        ...
        validate(MerchantMenuValidate::class)->scene('disable')->check($param);
    ...
    public function role()
    {
        ...
        validate(MerchantMenuValidate::class)->scene('role')->check($param);

        $where = $this->where(where_delete(['menu_ids', 'in', [$param['menu_id']]]));

        $data = MerchantMenuService::role($where, $this->page(), $this->limit(), $this->order());
    ...
    public function roleRemove()
    {
        ...
        validate(MerchantMenuValidate::class)->scene('roleRemove')->check($param);

        $data = MerchantMenuService::roleRemove($param['menu_id'], $param['role_ids']);
