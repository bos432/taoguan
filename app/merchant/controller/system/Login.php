...
use app\common\service\merchant\MerchantLoginService;
...
class Login extends BaseController
{
     ...
     * @Apidoc\Returned(ref="app\common\service\system\MerchantSettingService\info")
     * @Apidoc\NotHeaders()
     * @Apidoc\NotQuerys()
     * @Apidoc\NotParams()
     */
    ...
    {
        $data = MerchantSettingService::info('mer_system_name,mer_page_title,logo_url,favicon_url,login_bg_url,captcha_switch,captcha_mode,captcha_type,token_type,token_name,login_bg_color,page_limit');
    ...
    public function login()
    {
        ...
        validate(MerchantUserValidate::class)->scene('login')->check($param);
        ...
        $data = MerchantLoginService::login($param);
    ...
    public function logout()
    {
        ...
        $data = MerchantLoginService::logout($param['mer_user_id']);
