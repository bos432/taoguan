 ...
 * 个人中心验证器
 */
class MerchantUserCenterValidate extends Validate
{
    // 验证规则
    protected $rule = [
        'mer_user_id'      => ['require'],
    ...
    protected $scene = [
        'info' => ['mer_user_id'],
        'edit' => ['mer_user_id', 'username', 'nickname', 'phone', 'email'],
        'pwd'  => ['mer_user_id', 'password_old', 'password_new', 'phone'],
        'log'  => ['mer_user_id'],
    ];
    ...
    {
        $info = MerchantUserService::info($data['mer_user_id'] ?? 0);
