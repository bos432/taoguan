...
use app\common\validate\file\InspectionTagValidate;
...
class Tag extends BaseController
{
    ...
    public function list()
    {
        ...
        $data = InspectionTagService::list($where, $this->page(), $this->limit(), $this->order());
    ...
    public function info()
    {
        ...
        validate(InspectionTagValidate::class)->scene('info')->check($param);

        $data = InspectionTagService::info($param['tag_id']);
    ...
    public function add()
    {
        $param = $this->params(InspectionTagService::$edit_field);

        validate(InspectionTagValidate::class)->scene('add')->check($param);

        $data = InspectionTagService::add($param);
    ...
    public function edit()
    {
        ...
        validate(InspectionTagValidate::class)->scene('edit')->check($param);

        $data = InspectionTagService::edit($param['tag_id'], $param);
    ...
    public function dele()
    {
        ...
        validate(InspectionTagValidate::class)->scene('dele')->check($param);

        $data = InspectionTagService::dele($param['ids']);
    ...
    public function disable()
    {
        ...
        validate(InspectionTagValidate::class)->scene('disable')->check($param);

        $data = InspectionTagService::edit($param['ids'], $param);
    ...
    public function file()
    {
        ...
        validate(InspectionTagValidate::class)->scene('file')->check($param);

        $where = $this->where(where_delete(['tag_ids', 'in', [$param['tag_id']]]));

        $data = InspectionTagService::file($where, $this->page(), $this->limit(), $this->order());
    ...
    public function fileRemove()
    {
        ...
        validate(InspectionTagValidate::class)->scene('fileRemove')->check($param);

        $data = InspectionTagService::fileRemove($param['tag_id'], $param['file_ids']);
