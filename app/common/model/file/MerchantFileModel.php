 ...
 * 文件管理模型
 */
class MerchantFileModel extends Model
{
    // 表名
    protected $name = 'merchant_file';
    // 表主键
    ...
    {
        return $this->hasOne(MerchantGroupModel::class, 'group_id', 'group_id')->where([where_delete()]);
    }
    /**
     * 获取文件分组名称
     * @Apidoc\Field("")
    ...
    {
        return $this->belongsToMany(MerchantTagModel::class, MerchantTagsModel::class, 'tag_id', 'file_id');
    }
    /**
     * 获取标签id
     * @Apidoc\Field("")
