...
use app\common\service\inspection\InspectionLoginService;
...
class Login extends BaseController
{
     ...
     * @Apidoc\Returned(ref="app\common\service\system\InspectionSettingService\info")
     * @Apidoc\NotHeaders()
     * @Apidoc\NotQuerys()
     * @Apidoc\NotParams()
     */
    ...
    {
        $data = InspectionSettingService::info('ins_system_name,ins_page_title,logo_url,favicon_url,login_bg_url,captcha_switch,captcha_mode,captcha_type,token_type,token_name,login_bg_color,page_limit');
    ...
    public function login()
    {
        ...
        validate(InspectionUserValidate::class)->scene('login')->check($param);
        ...
        $data = InspectionLoginService::login($param);
    ...
    public function logout()
    {
        ...
        $data = InspectionLoginService::logout($param['ins_user_id']);
