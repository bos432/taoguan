...
class Member extends BaseController
{
    ...
    {
        $param = $this->params(['ids/a' => [], 'is_balance/d' => 0]);

        validate(MemberValidate::class)->scene('balance')->check($param);
    ...
    {
        $param = $this->params(['ids/a' => [], 'is_warehouse/d' => 0]);

        validate(MemberValidate::class)->scene('warehouse')->check($param);
