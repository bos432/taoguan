...
class UserService
{
    private static $builtin_report_permissions = [
        'admin/report.PlatformAnalytics/filters',
        'admin/report.PlatformAnalytics/summary',
        'admin/report.PlatformAnalytics/trend',
        'admin/report.PlatformAnalytics/ranking',
        'admin/report.PlatformAnalytics/alerts',
        'admin/report.PlatformAnalytics/merchantDetail',
        'admin/report.PlatformExport/orders',
        'admin/report.PlatformExport/merchants',
        'admin/report.PlatformExport/renewRecords',
        'admin/report.PlatformExport/analytics',
    ...
    public static function info($id, $exce = true, $role = false)
    {
        ...
        if (empty($info)) {
            ...
            $info['roles']    = self::appendBuiltinReportRoles(array_values($menu_urls), $info);
            $info['menus']    = self::appendBuiltinReportMenus(MenuService::menus($menu_ids), $info);
    ...
    private static function appendBuiltinReportRoles(array $menuUrls, array $info): array
    {
        if (!self::shouldExposeBuiltinReports($info)) {
            return array_values(array_unique($menuUrls));
        }

        return array_values(array_unique(array_merge($menuUrls, self::$builtin_report_permissions)));
    }

    private static function appendBuiltinReportMenus(array $menus, array $info): array
    {
        if (!self::shouldExposeBuiltinReports($info)) {
            return $menus;
        }
        ...
        $menus[] = [
            ...
            'children' => [
                [
                    ...
                    'component' => 'report/PlatformAnalytics',
                ],
                [
                    'menu_id' => -990003,
                    'menu_pid' => -990001,
                    ...
                    'component' => 'report/PlatformExport',
                ],
                [
                    'menu_id' => -990004,
                    'menu_pid' => -990001,
                    'path' => 'merchant-purchase-ledger',
                    'name' => 'MerchantPurchaseLedger',
                    'permission' => [
                        'admin/report.MerchantPurchaseLedger/filters',
                        'admin/report.MerchantPurchaseLedger/summary',
                        'admin/report.MerchantPurchaseLedger/list',
                    ...
                    'component' => 'report/merchant-purchase-ledger',
                ],
            ],
        ];
    ...
    private static function shouldExposeBuiltinReports(array $info): bool
    {
        if (user_is_super($info['user_id'] ?? 0)) {
            return true;
        }

        return (int)($info['is_super'] ?? 0) === 1;
    }
