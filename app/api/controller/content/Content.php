...
class Content extends BaseController
{
    ...
    public function getListByHome(){
        $data = ContentService::getListByHome();
        return success($data);
    }
...
//    protected $middleware = [ContentSettingMiddleware::class];
    ...
    public function list()
    {
        ...
        $field = 'm.content_id,unique,image_id,name,description,sort,hits,is_top,is_hot,is_rec,source,author,release_time,m.title,m.create_time';
