...
use app\common\validate\file\MerchantTagValidate;
...
class Tag extends BaseController
{
    ...
    public function list()
    {
        ...
        $data = MerchantTagService::list($where, $this->page(), $this->limit(), $this->order());
    ...
    public function info()
    {
        ...
        validate(MerchantTagValidate::class)->scene('info')->check($param);

        $data = MerchantTagService::info($param['tag_id']);
    ...
    public function add()
    {
        $param = $this->params(MerchantTagService::$edit_field);

        validate(MerchantTagValidate::class)->scene('add')->check($param);

        $data = MerchantTagService::add($param);
    ...
    public function edit()
    {
        ...
        validate(MerchantTagValidate::class)->scene('edit')->check($param);

        $data = MerchantTagService::edit($param['tag_id'], $param);
    ...
    public function dele()
    {
        ...
        validate(MerchantTagValidate::class)->scene('dele')->check($param);

        $data = MerchantTagService::dele($param['ids']);
    ...
    public function disable()
    {
        ...
        validate(MerchantTagValidate::class)->scene('disable')->check($param);

        $data = MerchantTagService::edit($param['ids'], $param);
    ...
    public function file()
    {
        ...
        validate(MerchantTagValidate::class)->scene('file')->check($param);

        $where = $this->where(where_delete(['tag_ids', 'in', [$param['tag_id']]]));

        $data = MerchantTagService::file($where, $this->page(), $this->limit(), $this->order());
    ...
    public function fileRemove()
    {
        ...
        validate(MerchantTagValidate::class)->scene('fileRemove')->check($param);

        $data = MerchantTagService::fileRemove($param['tag_id'], $param['file_ids']);
