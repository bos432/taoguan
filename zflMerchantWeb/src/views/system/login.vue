    ...
    setting() {
      ...
      setting()
        .then((res) => {
          ...
          this.system_name = data.mer_system_name
          ...
          settingsStore.changeSetting({ key: 'systemName', value: data.mer_system_name })
          settingsStore.changeSetting({ key: 'pageTitle', value: data.mer_page_title })
