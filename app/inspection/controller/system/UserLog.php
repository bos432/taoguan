...
class UserLog extends BaseController
{
    ...
    public function list()
    {
        ...
        $data = InspectionUserLogService::list($where, $this->page(), $this->limit(), $this->order());

        $data['user']  = InspectionUserService::list([where_delete()], 0, 0, [], 'ins_user_id,nickname,username')['list'] ?? [];
        $data['menu']  = InspectionMenuService::list('tree', [where_delete()], [], 'menu_id,menu_pid,menu_name');
    ...
    public function dele()
    {
        ...
        $data = InspectionUserLogService::dele($param['ids'], true);
    ...
    public function clear()
    {
        ...
        $data = InspectionUserLogService::clear($where);
