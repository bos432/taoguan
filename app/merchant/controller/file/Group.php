...
use app\common\validate\file\MerchantGroupValidate;
...
class Group extends BaseController
{
    ...
    public function list()
    {
        ...
        $data = MerchantGroupService::list($where, $this->page(), $this->limit(), $this->order());
    ...
    public function info()
    {
        ...
        validate(MerchantGroupValidate::class)->scene('info')->check($param);

        $data = MerchantGroupService::info($param['group_id']);
    ...
    public function add()
    {
        $param = $this->params(MerchantGroupService::$edit_field);

        validate(MerchantGroupValidate::class)->scene('add')->check($param);

        $data = MerchantGroupService::add($param);
    ...
    public function edit()
    {
        ...
        validate(MerchantGroupValidate::class)->scene('edit')->check($param);

        $data = MerchantGroupService::edit($param['group_id'], $param);
    ...
    public function dele()
    {
        ...
        validate(MerchantGroupValidate::class)->scene('dele')->check($param);

        $data = MerchantGroupService::dele($param['ids']);
    ...
    public function disable()
    {
        ...
        validate(MerchantGroupValidate::class)->scene('disable')->check($param);

        $data = MerchantGroupService::edit($param['ids'], $param);
    ...
    public function file()
    {
        ...
        validate(MerchantGroupValidate::class)->scene('file')->check($param);

        $where = $this->where(where_delete(['group_id', '=', $param['group_id']]));

        $data = MerchantGroupService::file($where, $this->page(), $this->limit(), $this->order());
    ...
    public function fileRemove()
    {
        ...
        validate(MerchantGroupValidate::class)->scene('fileRemove')->check($param);

        $data = MerchantGroupService::fileRemove($param['group_id'], $param['file_ids']);
