...
use app\common\validate\merchant\MerchantSettingValidate;
...
class Setting extends BaseController
{
     ...
     * @Apidoc\Returned(ref="app\common\service\system\MerchantSettingService\info", field="logo_url,favicon_url,login_bg_url")
     */
    public function systemInfo()
    {
        $data = MerchantSettingService::info('mer_system_name,mer_page_title,logo_id,favicon_id,login_bg_id,login_bg_color,page_limit,logo_url,favicon_url,login_bg_url');
    ...
    public function systemEdit()
    {
        ...
        validate(MerchantSettingValidate::class)->scene('system_edit')->check($param);

        $data = MerchantSettingService::edit($param);
    ...
    /**
     * @Apidoc\Title("缓存设置信息")
     * @Apidoc\Returned(ref="app\common\service\system\MerchantSettingService\info", field="cache_type")
     */
    public function cacheInfo()
    {
        $data = MerchantSettingService::info('cache_type');
    ...
    {
        $data = MerchantSettingService::cacheClear();
    ...
    {
        $data = MerchantSettingService::info('token_key,token_exp,is_multi_login');
    ...
    public function tokenEdit()
    {
        ...
        validate(MerchantSettingValidate::class)->scene('token_edit')->check($param);
    ...
    {
        $data = MerchantSettingService::info('captcha_switch,captcha_mode,captcha_type');
    ...
    public function captchaEdit()
    {
        ...
        validate(MerchantSettingValidate::class)->scene('captcha_edit')->check($param);
    ...
    {
        $data = MerchantSettingService::info('log_switch,log_save_time');
    ...
    public function logEdit()
    {
        ...
        validate(MerchantSettingValidate::class)->scene('log_edit')->check($param);
    ...
    {
        $data = MerchantSettingService::info('api_rate_num,api_rate_time');
    ...
    public function apiEdit()
    {
        ...
        validate(MerchantSettingValidate::class)->scene('api_edit')->check($param);
    ...
    {
        $data = MerchantSettingService::info('email_host,email_port,email_secure,email_username,email_password,email_setfrom,email_test');
    ...
    public function emailEdit()
    {
        ...
        validate(MerchantSettingValidate::class)->scene('email_edit')->check($param);
    ...
    public function emailTest()
    {
        ...
        validate(MerchantSettingValidate::class)->scene('email_test')->check($param);

        $data = MerchantSettingService::emailTest($param);
    ...
    public function serverInfo()
    {
        ...
        $data = MerchantSettingService::serverInfo($force);
